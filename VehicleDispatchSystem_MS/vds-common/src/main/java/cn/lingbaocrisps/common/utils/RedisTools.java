package cn.lingbaocrisps.common.utils;
...
public class RedisTools {
    ...
    public <E> List<E> range(String key, long start, long end) {
        ListOperations<String, E> listOperations = (ListOperations<String, E>) redisTemplate.opsForList();
    ...
    public <E> void rightPushAll(String key, List<E> list) {
    ...
    public <V> void zAdd(String key, Map<V, Double> map) {
